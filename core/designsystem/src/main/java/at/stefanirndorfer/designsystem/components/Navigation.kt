...
/**
 * Note: this is very much inspired by the Now In Android App's solution.
 */
...
fun RowScope.PMNavigationBarItem(
    ...
    NavigationBarItem(
        ...
        colors = NavigationBarItemDefaults.colors(
            selectedIconColor = PMNavigationDefaults.navigationSelectedItemColor(),
            unselectedIconColor = PMNavigationDefaults.navigationContentColor(),
            selectedTextColor = PMNavigationDefaults.navigationSelectedItemColor(),
